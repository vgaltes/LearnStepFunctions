...
```
"{\"Attack\": {\"Player\": {\"Level\": 10, \"Live\": 50}, \"Strength\": 10}, \"Defense
\": {\"Player\": {\"Level\": 8, \"Live\": 20}, \"Strength\": 60}}"
```
...
```
"{\"Attack\":{\"Player\":{\"Level\":10,\"Live\":50},\"Strength\":10},\"Defense\":{\"Player\":{\"Level\":8,\"Live\":10},\"Strength\":30}}"
```
